...
\paragraph    {inclination integer real\_1, real\_2 ..... real\_integer} : This keyword controls the
		     ...
		     angles is given first (integer) and then the inclination in radians 
		     (inclination =0. when the line of sight coincides with the z-axis)\\
		     $[$0$]$\\
