...
data(2,*) = data(2,*)*1.e36/Lstar
data1(2,*) = data1(2,*)*1.e36/Lstar
data2(2,*) = data2(2,*)*1.e36/Lstar

plot,data(1,*), data(2,*)*!pi ,xrange=[0.12,1000],yrange=[1.1e-5,1],psym=0,xtitle='!4k!X [!4l!Xm]', ytitle='relative flux',title='!4s!X (1!4l!Xm)=1, 10, 100',/xsty,/xlog,/ylog
