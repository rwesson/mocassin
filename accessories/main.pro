...
size_im = 16l;; size of the initial images to be read
...
rai1[mult_by_2,mult_by_2,mult_by_2].im1=0.
rai1[mult_by_2,mult_by_2,mult_by_2].im2=0.
...
flux_tot_beta =  total(rai1_a.im0) ;/4./!pi/(3.086d18*dist*1e3)^2
