FC  = mpif90
LIBS =	-lm
OPT1 = -fno-range-check -Jsource/ -ffree-line-length-0
OPT2 = -g
...
mocassin:
	$(FC) $(OPT1) -o mocassin $(SOURCES) source/mocassin.f90 $(LIBS)

mocassinWarm:
	$(FC) $(OPT1) -o mocassinWarm $(SOURCES) source/mocassinWarm.f90 $(LIBS)

mocassinOutput:
	$(FC) $(OPT1) -o mocassinOutput $(SOURCES) source/mocassinOutput.f90 $(LIBS)

mocassinPlot:
	$(FC) $(OPT1) -o mocassinPlot $(SOURCES) source/mocassinPlot.f90 $(LIBS)
